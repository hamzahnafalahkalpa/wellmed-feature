...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'wellmed-feature:migrate {--seed}';
     ...
     * @var string
     */
    protected $description = 'Run migrations for the WellmedFeature project';
    ...
    public function handle()
    {
        ...
        $this->info("Migrations for WellmedFeature project have been successfully executed.");

        if ($this->option('seed')){
            $this->info("Run seeding");
            Artisan::call('wellmed-feature:seed');
            $this->info("Seeded");
        }
        return Command::SUCCESS;
    }
